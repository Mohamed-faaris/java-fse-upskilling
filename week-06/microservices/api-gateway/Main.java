 ...
 * Refresh the eureka-discovery-server web page in browser, the accountservice will be listed in the
 * registry
 ...
 *
 * 13. Copy the “dependency-management” session in the pom.xml of the eureka-server and paste it
 ...
 *
 * 20. Include the following configuration in the “ application.properties” of the api-gateway to
 * specify
 ...
 *
 * 22. Try to access the url http://localhost:9090/greet-service/greet. You will get the output as
 * shown
 * below.
 *
