 ...
 * Create a new method in component with the name as loadPosts() which will be responsible for using
 * Fetch API and assign it to the component state created earlier. To get the posts use the url
 ...
 * Implement the render() which will display the title and post of posts in html page using heading and
 * paragraphs respectively.
 *
 *
 * Figure 6: render() method
 * Define a componentDidCatch() method which will be responsible for displaying any error happing in
 * the component as alert messages.
 *
 *
