 ...
 * o
 *
 * Write code to load the JDBC driver, create a connection, execute a SELECT query, and
 * print results.
 *
 ...
 * o
 *
 * Accept client connections and use InputStream and OutputStream for two-way
 * communication.
 *
 * o
 *
