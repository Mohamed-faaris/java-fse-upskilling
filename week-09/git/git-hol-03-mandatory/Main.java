 ...
 * Please follow the instruction to complete the hands-on. Each instruction expects a command for the
 * Git Bash.
 *
 * Branching:
 * Create a new branch “GitNewBranch”.
 * List all the local and remote branches available in the current trunk. Observe the “*” mark which
 * denote the current pointing branch.
 ...
 * List out all the differences between trunk and branch. These provide the differences in command line
 * interface.
