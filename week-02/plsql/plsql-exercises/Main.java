 ...
 * Question: Write a stored procedure UpdateSalary that increases the salary of an employee by a given
 * percentage. If the employee ID does not exist, handle the exception and log an error message.
 * Scenario 3: Ensure data integrity when adding a new customer.
 * Question: Write a stored procedure AddNewCustomer that inserts a new customer into the Customers
 * table. If a customer with the same ID already exists, handle the exception by logging an error and
 ...
 * Question: Write a function CalculateAge that takes a customer's date of birth as input and returns
 * their age in years.
 *
 ...
 * Question: Write a trigger UpdateCustomerLastModified that updates the LastModified column of the
 ...
 * Question: Write a PL/SQL block using an explicit cursor UpdateLoanInterestRates that fetches all
 * loans and updates their interest rates based on the new policy.
 *
 * Exercise 7: Packages
 *
 * Scenario 1: Group all customer-related procedures and functions into a package.
 * Question: Create a package CustomerManagement with procedures for adding a new customer, updating
 * customer details, and a function to get customer balance.
 * Scenario 2: Create a package to manage employee data.
 * Question: Write a package EmployeeManagement with procedures to hire new employees, update employee
 * details, and a function to calculate annual salary.
 * Scenario 3: Group all account-related operations into a package.
 * Question: Create a package AccountOperations with procedures for opening a new account, closing an
 * account, and a function to get the total balance of a customer across all accounts.
 *
